...
public class BalanceSheetController {
    public void updateUserExpenseBalanceSheet(User expensePaidBy, List<Split> splitDetails, double totalExpenseAmount) {
        UserExpenseBalanceSheet paidByUserExpenseSheet = expensePaidBy.getUserBalanceSheet();
        ...
        for(Split split : splitDetails) {
            ...
            UserExpenseBalanceSheet oweUserExpenseSheet = userOwe.getUserBalanceSheet();
    ...
    public void showBalanceSheetOfUser(User user){
        ...
        UserExpenseBalanceSheet userExpenseBalanceSheet =  user.getUserBalanceSheet();
